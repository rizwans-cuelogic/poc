...
class Test1(TestCase):
	...
	def test_register(self):
		...
		response = client.post(reverse('register'), {'username': 'abc123','email': 'abc@gmail.com', 'password': 'As123456','password1':'As123456', 'orgname': 'Uvitransform', 'orglogo':File(open('/home/rizwan/Downloads/gile.jpg','r'))})
	...
	def test_login_fail(self):
		user1=User.objects.create(username='asd123', email="asd@gmail.com",password='pass1234',is_active=True)
		client=Client()
		response=client.post(reverse('loginresult'),{'username':'asd123','password':'As123456'})
		self.assertTrue(response.status_code,200)
		print response.content
	...
	def test_recover_password(self):
		...
		client=Client()
		password={'password':'As123456','password1':'As123456','hash':hash1}
